...
export default {
  ...
  methods:{
    atualizarLista(){
      this.$http.get('http://lista-de-tarefas-api.herokuapp.com/api/listartarefas')
        .then(res => res.json())
        .then(tarefas => this.tarefas = tarefas);
    },
    novaTarefa(){
      if(this.inputTarefa != ""){
        let endpoint = 'http://lista-de-tarefas-api.herokuapp.com/api/NovaTarefa/'+this.inputTarefa
        this.realizaChamadaEExibeAlerta(endpoint);
      }
      this.atualizarLista();
    },
    deletaTarefa(id){
      let endpoint = 'http://lista-de-tarefas-api.herokuapp.com/api/RemoverTarefa/'+id;
      this.realizaChamadaEExibeAlerta(endpoint);
      this.atualizarLista();
    },
    finalizarTarefa(id){
      let endpoint = 'http://lista-de-tarefas-api.herokuapp.com/api/FinalizarTarefa/'+id;
      this.realizaChamadaEExibeAlerta(endpoint);
      this.atualizarLista();
    },
    finalizarTarefaSilenciosamente(id){
        this.$http.get('http://lista-de-tarefas-api.herokuapp.com/api/FinalizarTarefa/'+id)
        .then(res => res.json())
    ...
    editarTarefa(id){
      ...
      let endpoint = 'http://lista-de-tarefas-api.herokuapp.com/api/EditarTarefa/'+id+'/'+descricao;
      if(descricao!=null){
        this.realizaChamadaEExibeAlerta(endpoint);
      }
      this.atualizarLista();
